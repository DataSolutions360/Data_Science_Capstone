...
function reset() {
    ...
    document.getElementById("healthnotgood").selectedIndex = 0;
    document.getElementById("BMI").selectedIndex = 0;
    document.getElementById("diabetes").selectedIndex = 0;
    document.getElementById("mhealthnotgood").selectedIndex = 0;
    ...
    document.getElementById("cancer").selectedIndex = 0;
